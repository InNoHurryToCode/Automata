...
#define AUTOMATA_INPUT_MOUSE_AXES_AMOUNTT 2
#define AUTOMATA_INPUT_GAMEPAD_BUTTONS_AMOUNT 18
#define AUTOMATA_INPUT_GAMEPAD_AXES_AMOUNT 4

#define AUTOMATA_INPUT_KEYS_AMOUNT AUTOMATA_KEY_GAMEPAD_16_18 + 1
#define AUTOMATA_INPUT_AXES_AMOUNT AUTOMATA_AXIS_GAMEPAD_16_RTHUMB_Y + 1
#define AUTOMATA_INPUT_GAMEPADS_AMOUNT GLFW_JOYSTICK_LAST + 1
