...
/* window modes */
#define AUTOMATA_WINDOW_MODE_WINDOWED 0
#define AUTOMATA_WINDOW_MODE_FULLSCREEN 1
#define AUTOMATA_WINDOW_MODE_BORDERLESS 2
#define AUTOMATA_WINDOW_MODE_UNKNOWN -1
